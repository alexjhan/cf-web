          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center justify-center h-8 w-8 text-gray-400 hover:text-[#FFD700] focus:outline-none bg-transparent"
